...
local m = Map("openvpn", translate("SSLVPN"))
local s = m:section( TypedSection, "openvpn", translate(""), translate("Below is a list of configured SSLVPN instances and their current state") )
