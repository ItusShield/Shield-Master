...
m = Map("vnstat", translate("Traffic Monitor"),
	translate("Traffic Monitor keeps a log of network traffic for the selected interface(s)."))

m.submit = translate("Restart Traffic Monitor")
m.reset  = false
